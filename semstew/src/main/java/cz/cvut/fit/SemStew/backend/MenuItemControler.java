...
import cz.cvut.fit.SemStew.backend.Services.MenuServices.CategoriesNameService;
import cz.cvut.fit.SemStew.backend.Services.MenuServices.MenuItemNameService;
import cz.cvut.fit.SemStew.backend.Services.MenuServices.MenuItemService;
...
public class MenuItemControler {
    ...
    private AboutUsConfigService.UnitsService unitsService = new AboutUsConfigService.UnitsService();
